...
@section('title_page')
    {{displayTitleSaveTypePost($type, true)}}
@endsection
...
@section('content')
    <div class="min-height-200px">
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <nav aria-label="breadcrumb" role="navigation">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{displayTitleSaveTypePost($type, true)}}</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="card-box mb-30">
            <div class="pd-20">
                <h4 class="text-blue h4">{{displayTitleSaveTypePost($type, true)}}</h4>
            </div>
            <div class="pb-20 container">
                <form method="post" action="{{route('admin.posts.update', ['type' => $type, 'post' => $post->id])}}" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
