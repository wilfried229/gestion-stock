...
@section('title_page')
    Modification d'une nouvelle émission
@endsection
...
@section('content')
    <div class="min-height-200px">
        ...
        <div class="row mb-2">
            <div class="col-md-12 col-sm-12 text-left">
                <a href="{{route('admin.radio.emission.index', ['radio' => $radio])}}" class="btn btn-sm btn-secondary">
    ...
    <!-- Export Datatable start -->
        <div class="card-box mb-30">
            <div class="pd-20">
                <h4 class="fw-bold h4">Modification d'une émission</h4>
            </div>
